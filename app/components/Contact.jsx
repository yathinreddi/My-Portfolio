...
const Contact = () => {
    ...
    const onSubmit = async (event) => {
        ...
        formData.append("access_key", "8236d46a-30b8-45aa-8917-ba8f3fcd0930");
  ...
  return (
    ...
    id="contact" className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length:90%_auto] dark:bg-none'>
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>To reach out, please use the form below.</motion.p>
        ...
        onSubmit={onSubmit} className='max-w-2xl mx-auto'>
            ...
            type='submit' className='py-3 px-8 w-max flex items-center justify-between gap-2 bg-black gap-2 bg-black/ 80 text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover;bg-darkHover'>Submit now <Image src={assets.right_arrow_white} alt='' className='w-4'/></motion.button>
